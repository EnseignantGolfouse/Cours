...
\begin{methode}[Simplifier une fraction]
	Il est possible de simplifier au maximum une fraction, en divisant le numérateur et le dénominateur par leur \textbf{PGCD} (vu au chapitre 1 : multiples, diviseurs, nombres premiers).
\end{methode}
