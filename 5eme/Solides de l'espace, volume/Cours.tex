...
\usetikzlibrary{calc,positioning,snakes}
...
\begin{cours}[Patron du pavé droit]
	...
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\draw[fill=red!30] (\patronX,\patronY) -- ++(\rectWidth,0) -- ++(0,-\rectDepth) -- ++(-\rectWidth,0) -- cycle;
			\draw[fill=blue!30] (\patronX + \rectWidth,\patronY) -- ++(\rectHeight,0) -- ++(0,-\rectDepth) -- ++(-\rectHeight,0) -- cycle;
			\draw[fill=red!30] (\patronX + \rectWidth + \rectHeight,\patronY) -- ++(\rectWidth,0) -- ++(0,-\rectDepth) -- ++(-\rectWidth,0) -- cycle;
			\draw[fill=blue!30] (\patronX + \rectWidth + \rectWidth + \rectHeight,2) -- ++(\rectHeight,0) -- ++(0,-\rectDepth) -- ++(-\rectHeight,0) -- cycle;
			\draw[fill=green!30] (\patronX + \rectWidth + \rectHeight,\patronY + \rectHeight) -- ++(\rectWidth,0) -- ++(0,-\rectHeight) -- ++(-\rectWidth,0) -- cycle;
			\draw[fill=green!30] (\patronX + \rectWidth + \rectHeight,\patronY - \rectDepth) -- ++(\rectWidth,0) -- ++(0,-\rectHeight) -- ++(-\rectWidth,0) -- cycle;
		\end{tikzpicture}
	\end{center}
\end{cours}
