...
\begin{center}
	\LARGE
	\myuline{Activité : Introduction à Scratch}
\end{center}
...
\begin{exercice}
	Pour lancer un programme, il \myuline{faut} utiliser un block \textit{Évènement}, en jaune. Place le block drapeau (\includegraphics[width=5em]{Images/Block drapeau.png}) dans le panneau des scripts. \\
