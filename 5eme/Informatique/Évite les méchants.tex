...
\begin{attention}
	Si tu as du mal, rappelles-toi : on veut que \myuline{si} le méchant nous touche, \myuline{alors} on a perdu. Essaye de trouver un block utilisant ces deux mots...
\end{attention}
