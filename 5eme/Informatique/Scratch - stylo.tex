	      ...
	      \begin{itemize}
		      ...
		      \item Accroche les instructions suivantes au nouveau block :
		            \begin{itemize}
			            ...
			            \item[] \squared[cyan]{donner la valeur \circled{0} à x}
			            \item[] \squared[cyan]{donner la valeur \circled{0} à y}
			            \item[] \squared[cyan]{s'orienter à \circled{90}}
			            \item[] \squared[Green]{stylo en position d'écriture}
			            \item[] \squared[Green]{effacer tout}
		            \end{itemize}
	      \end{itemize}
	      Tu peux maintenant utiliser le block \squared[violet]{Réinitialiser} pour effacer le dessin et mettre le stylo au centre de l'écran.
\end{enumerate}

\section{Premiers dessins}

\begin{enumerate}
	\item Utilise à la suite le block \squared[violet]{Réinitialiser} et \squared[cyan]{avance \circled{50}}.
