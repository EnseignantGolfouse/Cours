...
\begin{cours}[Calcul sans parenthèses]
	\begin{itemize}
		\item Dans une expression sans parenthèses ne contenant que des \textbf{additions} et des \textbf{soustractions}, on effectue les calculs \myuline{de la gauche vers la droite}.
		\item Dans une expression sans parenthèses ne contenant que des \textbf{multiplications} et des \textbf{divisions}, on effectue les calculs \myuline{de la gauche vers la droite}.
	\end{itemize}
\end{cours}
