...
\begin{exercice}[(3 points)]\
	...
	Trace le symétrique de la figure par rapport à l'axe $(d)$ :
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.8]
			...
			% tikz_draw_points(symetrie_axiale(d, points1), "thick")
			tikz_draw_points(points2, "thick")
			% tikz_draw_points(symetrie_axiale(d, points2), "thick")
			tikz_draw_points(points3, "thick")
			% tikz_draw_points(symetrie_axiale(d, points3), "thick")
			}
...
\begin{exercice}[(3 points)]\
	...
	Trace le symétrique de la figure par rapport au point $C$ : \vspace{1em}
	...
	\begin{center}
		\begin{tikzpicture}[scale=1.2]
			...
			% \draw[thick, rotate around={180:(C)}] (-1,1) -- ++(3,0) -- ++(-3,3) -- ++(3,0) -- cycle;
			% \draw[thick, rotate around={180:(C)}] (-0.5,1.5) -- ++(2,0);
			% \draw[thick, rotate around={180:(C)}] (1,3) -- ++(-1,0);
			% \draw[thick, rotate around={180:(C)}] (0.5,2.5) -- ++(0,-1);
		\end{tikzpicture}
	\end{center}
\end{exercice}
